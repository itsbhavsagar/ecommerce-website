  ...
  return (
    ...
    <div className="grid lg:grid-cols-3 gap-10 p-4">
      <div className="lg:col-span-2 bg-white divide-y">
        ...
        <div className="flex items-start max-sm:flex-col gap-4 py-4">
          <div className="h-36 shrink-0">
            <img src='https://readymadeui.com/images/product6.webp' className="w-full h-full object-contain rounded-md" />
          </div>

          <div className="flex items-start gap-4 w-full">
            <div>
              <h3 className="text-lg font-bold text-gray-800 mb-1">Black T-Shirt</h3>
            ...
            <div className="ml-auto text-right">
              ...
              <div className="mt-4">
                <h4 className="text-lg font-bold text-gray-500 mb-1"><strike className="font-medium">$22.5</strike></h4>
      ...
      <div className="shadow-md p-6 lg:sticky lg:top-0 h-max">
        ...
        <button type="button" className="mt-4 text-sm px-5 py-2.5 w-full bg-blue-600 hover:bg-blue-700 text-white rounded-md">Make Payment</button>
